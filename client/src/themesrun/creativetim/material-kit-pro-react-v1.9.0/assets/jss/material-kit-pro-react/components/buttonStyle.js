...
const buttonStyle = {
  ...
  primary: {
    ...
    + "0 3px 1px -2px rgba(" + hexToRgb(overtheme.primaryColorHex[0])  + ", 0.2)" 
    + "0 1px 5px 0 rgba(" + hexToRgb(overtheme.primaryColorHex[0])  + ", 0.12)" 
    : "0 4px 23px 0px rgba(" + hexToRgb(blackColor)  + ", 0.14)" 
  ...
  secondary: {
    ...
    backgroundColor: ({ overtheme }) => overtheme ? "rgba(" + overtheme.secondaryColor[0].r + ", " + overtheme.secondaryColor[0].g + ", " + overtheme.secondaryColor[0].b + ", "+ overtheme.secondaryColor[0].a + ")": 
    "rgba(" + mysecondaryColor[0].r + ", " + mysecondaryColor[0].g + ", " + mysecondaryColor[0].b + ", "+ mysecondaryColor[0].a + ")",
    boxShadow: ({ overtheme }) =>
    overtheme ? 
    "0 2px 2px 0 rgba(" + hexToRgb(overtheme.secondaryColorHex[0])  + ", 0.14)" 
    + "0 3px 1px -2px rgba(" + hexToRgb(overtheme.secondaryColorHex[0])  + ", 0.2)" 
    + "0 1px 5px 0 rgba(" + hexToRgb(overtheme.secondaryColorHex[0])  + ", 0.12)" 
    : "0 4px 23px 0px rgba(" + hexToRgb(blackColor)  + ", 0.14)" 
    + "0 4px 23px 0px rgba(" + hexToRgb(blackColor)  + ", 0.2)"
    + "0 4px 23px 0px rgba(" + hexToRgb(blackColor)  + ", 0.12)",
    "&:hover,&:focus": {
