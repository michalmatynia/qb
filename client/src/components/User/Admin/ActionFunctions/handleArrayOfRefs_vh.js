...
export async function actionFuncs_convertArrayOfRefs_vh1({ cell = null }) {
...
export async function actionFuncs_populateArrayOfRefsForDb_vh2({ dispatch = null, cell = null, getlist = null,  populate = null, poliglot = null, fields = null, mypath = null, language = null, country = null }) {
    let inQuery
    let cellkey
    let cellvalue
    ...
    for (let eachmodel of filteredmodels) {
        ...
        let populatedresult = await plg_findMany({ model: eachmodel, dispatch, actionType: 'samestate', inQuery, populate })
