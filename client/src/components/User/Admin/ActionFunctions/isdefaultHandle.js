...
export async function actionFuncs_isDefaultHandle({ cell = null, myprops = null, model = null, mystate = null, added = null, current = null }) {
    ...
    if (added.payload.isdefault === false && current) {
        ...
        if (current.isdefault !== added.payload.isdefault) {
            ...
            let updatedlist = await plg_findMany({ model, myprops, actionType: 'samestate', inQuery, inOperator, distinct: '_id' })
