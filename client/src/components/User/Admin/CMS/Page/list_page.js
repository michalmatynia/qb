...
class ListPage extends Component {
    ...
    async componentWillUnmount() {
        ...
        await plg_clearProps({ myprops: this.props, model: this.state.localStorage.model, actionType: 'current_list' })
        await plg_clearProps({ myprops: this.props, model: this.state.localStorage.model, actionType: 'current_detail' })
