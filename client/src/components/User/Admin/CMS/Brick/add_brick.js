...
class AddBrick extends Component {
    ...
    submitForm = async ({ translate = null }) => {
        ...
        newLocalStorage = await attachtoFuncs_overModel_Add({
            translate,
            model: 'page',
            ...
            newLocalStorage,
            added,
            attacher: newLocalStorage.attachto.page
        })
    }

        let sublistkey = 'sublist'
        newLocalStorage.attachto.page = []
...
export default connect(mapStateToProps)(AddBrick);