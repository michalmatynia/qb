...
import { actionFuncs_isDefaultOnRemove } from '../../ActionFunctions/isdefaultHandle'
// Generic Functions
...
import { toggle_isDefault_v1 } from '../../EventFuncs/toggle_funcs'
...
class ListMysite extends Component {
    ...
    async componentDidUpdate(prevProps, prevState) {
            ...
            if (
                this.props.mysite.CurrentMysite !== prevProps.mysite.CurrentMysite
    ...
    onRemoveItem = async ({ event, removeall = null, value = null, cell = null, sublistkey = null, tiedtoformkey = null }) => {

        await actionFuncs_isDefaultOnRemove({
            value,
            myprops: this.props,
            model: this.state.localStorage.model,
            mystate: this.state,
        ...
        if (value.isdefault) {
            ...
            // Mysite specific code, to setdefault after removal
            let inQuery = {
                isdefault: { "$eq": true }
            }
            await plg_findOne_QueMod({
                ...
                actionType: 'current',
                inQuery,
                populate: [{ path: 'default_language' }, { path: 'default_language', populate: { path: 'referenceID' } }]
            })
        }
...
export default connect(mapStateToProps)(ListMysite);