...
class ListBlockstyle extends Component {
    ...
    onRemoveItem = async ({ event, removeall, value = null, cell = null, sublistkey = null, tiedtoformkey = null }) => {
        ...
        await remove_fromOverMods({
            value,
            removeall,
            overmodel: Object.keys(this.state.localStorage.attachto)[0],
            // submodel: this.props.match.params.model,
...
export default connect(mapStateToProps)(ListBlockstyle);