...
import { actionFuncs_populateArrayOfRefsForDb_v2 } from '../ActionFunctions/handleArrayOfRefs'
import { actionFuncs_recalculateOnWall } from '../ActionFunctions/recalculatePrice'

export async function brickFuncs_populateMultimodelWithQty_preInput({ myprops = null, mystate = null, prospect = null, language = null, country = null, models = null, target_lg = null, source_lg }) {
    ...
    if (prospect.checked.length > 0) {
        ...
        let checked_populated = await actionFuncs_populateArrayOfRefsForDb_v2({ getlist: prospect['checked'], myprops, populate: [{ path: 'referenceID' }], mypath: 'referenceID' })
        ...
        for (let submodel of models) {
            ...
            if (filteredsubs.length > 0) {
                ...
                for (let each_checked of my_sub_checked_array) {
                    ...
                    let found_content = await plg_findOne_QueMod({ model: submodel, myprops, actionType: 'samestate', inQuery })
...
export async function brickFuncs_populateMultimodel_preInput({ myprops = null, mystate = null, prospect = null, language = null, country = null, models, target_lg, source_lg }) {
