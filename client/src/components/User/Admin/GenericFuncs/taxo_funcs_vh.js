...
export async function taxoFuncs_removeSubtags_vh3({ dispatch = null, removed = null, model = null}) {
    ...
    let listWithTag = await plg_findMany({ model, dispatch, actionType: 'samestate', inQuery })
