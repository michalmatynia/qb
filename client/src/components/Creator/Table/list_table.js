...
export default function ListTable({ viewparams = null, tableparams = null, sublistkey = null, tiedtoformkey = null,  model = null, mystate = null, changePosition = null, changeSort = null, handleSwitch = null, removeItem = null, toggleItem = null }) {
    let list = useSelector(state => state[model].list)

//   let list = sublistkey ? myprops[mystate.localStorage[sublistkey].viewmodel].list : myprops[mystate.localStorage.model].list
