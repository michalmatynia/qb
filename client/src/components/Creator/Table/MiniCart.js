...
export default function MiniCart({ viewparams = null, list = null, headerparams = null, rowparams = null, model = null, changeQuantity = null, handleSwitch = null, removeItem = null, toggleItem = null }) {
    ...
    function loopTableHeader({ headerparams }) {
        ...
        //     tableparams.columns ? tableparams.columns.map((value, i) => {
        // value.config.label
        //   }) : []
